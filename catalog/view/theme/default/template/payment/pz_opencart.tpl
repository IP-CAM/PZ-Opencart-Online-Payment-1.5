...
<form action="<?php echo $action; ?>" method="post" id="pz_opencart_standard_checkout" name="ecom">
    ...
    <div class="buttons">
        <div class="right">
            <a id="button-confirm" class="button" onclick="$('#pz_opencart_standard_checkout').submit();">
